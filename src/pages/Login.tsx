...
const Login = () => {
  ...
  return <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-royal-light/10 via-background to-golden-light/10 p-4">
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-8">
            <h2 className="text-2xl font-bold text-center text-royal mb-2">
              Sign In
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input 
                    ...
                    required 
                    className="bg-blue-50/50 border-royal/20 focus-visible:ring-royal pr-10" 
                  />
                  <button 
                    type="button"
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-royal transition-colors"
              ...
              <div className="text-center mt-6">
                <p className="text-sm text-gray-600">
                  ...
                  <Link to="/register" className="text-royal hover:text-royal-dark font-medium hover:underline">
                    Sign up here
                  </Link>
                </p>
              </div>
